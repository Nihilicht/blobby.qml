...
class BlobRect : public BlobShape {
    ...
    Q_PROPERTY(qreal maxStretch READ maxStretch WRITE setMaxStretch NOTIFY maxStretchChanged)
...
public:
    ...
    static constexpr qreal DefaultStiffness = 200.0;
    static constexpr qreal DefaultDamping = 16.0;
    static constexpr qreal DefaultDeformScale = 0.0005;
    static constexpr qreal DefaultMaxStretch = 0.35;
    ...
    qreal maxStretch() const { return m_maxStretch; }

    void setMaxStretch(qreal v) {
        if (!qFuzzyCompare(m_maxStretch, v)) {
            m_maxStretch = v;
            emit maxStretchChanged();
        }
    }
...
private:
    ...
    qreal m_stiffness = DefaultStiffness;
    qreal m_damping = DefaultDamping;
    qreal m_deformScale = DefaultDeformScale;
    qreal m_maxStretch = DefaultMaxStretch;
